...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1668545984);
user_pref("app.update.lastUpdateTime.background-update-timer", 1668546224);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1668546104);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1668545631);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1668546344);
...
user_pref("extensions.zotero.sync.server.username", "thor314");
